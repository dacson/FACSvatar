...
class SubscribeProcessor:
    ...
    def subscribed(self, counter, id, type):
        print('----------------------------')
...
class ClientSession(ApplicationSession):
    ...
    async def onJoin(self, details):
        ...
        await self.subscribe(self.subscribe_processor.subscribed, u'com.example.oncounter')
        ...
        while True:
            ...
            try:
                message = await self.publish_processor.publishing()
